...
play_button = Button.Button(computer_width_res, computer_height_res * 0.35, play_menu, 0.7, play_menu_hover)
exit_button = Button.Button(computer_width_res, computer_height_res * 0.5, exit_menu, 0.7, exit_menu_hover)
